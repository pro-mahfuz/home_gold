...
import { update, fetchById } from "../../invoice/features/invoiceThunks";
...
export default function BillEditForm() {
  ...
  return (
    <div>
      <PageMeta title={`${invoiceType ? invoiceType.charAt(0).toUpperCase() + invoiceType.slice(1).toLowerCase() : ''} Update`} description="Edit Bill" />
      <PageBreadcrumb pageTitle={`${invoiceType ? invoiceType.charAt(0).toUpperCase() + invoiceType.slice(1).toLowerCase() : ''} Update`} />
      ...
      <div className="mb-4 flex justify-start">
        <div>
          ...
          <button
            onClick={() => {if (invoice) handleView(invoice)}}
